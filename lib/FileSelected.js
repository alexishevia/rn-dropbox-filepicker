...
export default function FileSelected({ filepath, openFilePicker, onLogout, fileSelectedMsg, fileChangeWarningMsg }) {
  return (
    <View>
      ...
      >
        <ChangeFileButton onPress={openFilePicker} fileChangeWarningMsg={fileChangeWarningMsg}/>
